...
public abstract class AbstractIntArrayAssert<S extends AbstractIntArrayAssert<S>>
  extends AbstractArrayAssert<S, int[], Integer> implements IIntArrayAssert<S> {
   ...
   */
  @Override public S contains(int... values) {
   ...
   */
  @Override public S containsOnly(int... values) {
   ...
   */
  @Override public S containsOnlyOnce(int... values) {
   ...
   */
  @Override public S containsSequence(int... sequence) {
   ...
   */
  @Override public S containsSubsequence(int... subsequence) {
   ...
   */
  @Override public S contains(int value, Index index) {
   ...
   */
  @Override public S doesNotContain(int... values) {
   ...
   */
  @Override public S doesNotContain(int value, Index index) {
   ...
   */
  @Override public S startsWith(int... sequence) {
   ...
   */
  @Override public S endsWith(int... sequence) {
   ...
   */
  @Override public S containsExactly(int... values) {
